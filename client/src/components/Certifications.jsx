...
const Certifications = () => {
  ...
  useEffect(() => {
    client.fetch(`*[_type == "certification"] | order(order asc)`).then(setCerts).catch(() => {});
  }, []);
  ...
  const certificationsData = certs && certs.length > 0 ? certs : FALLBACK_CERTS;
      ...
      <div className="absolute inset-0">
        ...
        {[...Array(15)].map((_, i) => (
          <motion.div
            ...
            animate={{ y: [0, -50, 0], x: [0, Math.random() * 30 - 15, 0], opacity: [0, 1, 0] }}
            transition={{ duration: 6 + Math.random() * 4, repeat: Infinity, ease: "linear", delay: Math.random() * 3 }}
          />
        ))}
      </div>
            ...
            >
              ...
              <div className="p-4 relative">
                ...
                <div className="flex flex-wrap gap-1 mb-3">
                  {cert.skills && cert.skills.slice(0, 3).map((skill, i) => (
                    <span key={i} className="px-1.5 py-0.5 bg-purple-500/20 text-purple-300 rounded-md text-[10px] font-medium">
                      {skill}
                    </span>
                  ))}
          ...
          >
            ...
            >
              <div className="flex justify-between items-start mb-6">
                ...
                <button onClick={() => setSelectedCert(null)} className="text-gray-400 hover:text-white transition-colors">
              ...
              <img src={selectedCert.image} alt={selectedCert.title} className="w-full h-48 object-cover rounded-lg mb-6" />
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedCert.skills && selectedCert.skills.map((skill, i) => (
                      <span key={i} className="px-3 py-1 bg-purple-500/20 text-purple-300 rounded-md text-sm font-medium">{skill}</span>
                    ))}
                  </div>
                </div>
