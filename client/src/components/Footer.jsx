  ...
  return (
    <footer className="bg-gray-900 py-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0 border-b border-gray-800 pb-6">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <a
              href="mailto:savanthpamu333@gmail.com"
            ...
            >
              ...
              <span>savanthpamu333@gmail.com</span>
            </a>
            <a
        ...
        <div className="pt-4 text-center text-sm text-gray-400">
          © {currentYear} Savanth Pamu. All rights reserved.
        </div>
      </div>
    </footer>
  );
